...
namespace GameFramework
{
    ...
    public class SceneReference : ISerializationCallbackReceiver
    {
        ...
        {
            get { return ScenePath.Split('/').Last().Split('.')[0]; }
        }

        public bool PresentInBuildSettings
        {
            get
            {
#if UNITY_EDITOR
                return EditorBuildSettings.scenes.FirstOrDefault(x => x.path == ScenePath) != null;
#else
                return true;
#endif
            }
    ...
    public class SceneReferencePropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var selectedObject = EditorGUI.ObjectField(
                position, label, sceneAssetProperty.objectReferenceValue, typeof(SceneAsset), false);
